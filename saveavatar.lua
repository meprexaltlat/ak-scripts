...
local function resetRespawnFlag()
...
local function refreshOutfitList()
    ...
    for i, outfit in ipairs(savedOutfits) do
        ...
        applyButton.MouseButton1Click:Connect(function()
            if player.Character and not isRespawning then
                ...
                if isRespawning then
                    updateStatus("Please wait, character is respawning!", Color3.fromRGB(255, 200, 50))
                else
